...
<body>
    ...
    <div class="px-4 mt-5">
        <h2 class="text-center mb-4">Laba Rugi</h2>
        <table class="table">
            ...
            $result = mysqli_query($conn, "SELECT IFNULL(sum(Penjualan.HargaJual),0) - IFNULL(sum(Pembelian.HargaBeli), 0) as Keuntungan, NamaBarang
            FROM Barang 
