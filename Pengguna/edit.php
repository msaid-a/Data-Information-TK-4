...
<form action="edit_data.php" method="post" class="px-4 w-50 mx-auto"> 
    ...
    <input class="form-control mt-3" type="password" name="password" placeholder="Password" value="<?php echo $Password ?>">
    <input class="form-control mt-3" type="text" name="firstname" placeholder="Nama Depan" value="<?php echo $firstname ?>">
    <input class="form-control mt-3" type="text" name="lastname" placeholder="Nama Belakang" value="<?php echo $lastname ?>">
    <input class="form-control mt-3" type="text" name="alamat" placeholder="Alamat" value="<?php echo $Alamat ?>">
    <select class="form-select mt-3" aria-label="Default select example" name="idAksess" placeholder="Hak Aksess" value="<?php echo $idAksess ?>">
